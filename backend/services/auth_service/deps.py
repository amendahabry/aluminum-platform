"""Auth service dependencies: DB session, current user, tenant scope."""
from typing import Annotated

from fastapi import Depends, HTTPException, status
from sqlalchemy.orm import Session

from shared.db.session import get_db, get_current_tenant_id
...
def require_tenant_and_db(
    user: Annotated[dict, Depends(get_current_user)],
):
    """Set tenant context from JWT and return user (for use in routers)."""
