"""Management service: dashboards and reports."""
import os
...
from .routers import dashboards, reports
...
def create_app() -> FastAPI:
    app = FastAPI(
        title="Aluminum Management Service",
        version="1.0.0",
        openapi_tags=[
            {"name": "dashboards", "description": "KPI dashboards"},
